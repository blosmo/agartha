...
export type QualityInput = { meshy?: StudioMeshyContext; kind: 'strategy' | 'review'; brief: string; remainingCents: number; images?: StudioImage[]; strategy?: unknown; candidateRevision?: number; glbSha256?: string };
