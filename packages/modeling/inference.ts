...
type StepInput = { jobId: string; executorId: string; operationId: string; brief: string; history: string; image?: string; remainingCents: number; protocol?: 2; kind?: 'modeling' | 'critique'; images?: StudioImage[] };
