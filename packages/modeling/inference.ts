...
import { studioRequest, parseStudioAction, type StudioImage, type StudioMeshyContext } from './studio.js';
...
type StepInput = { meshy?: StudioMeshyContext; jobId: string; executorId: string; operationId: string; brief: string; history: string; image?: string; remainingCents: number; protocol?: 2 | 3; kind?: 'modeling' | 'strategy' | 'review' | 'critique'; images?: StudioImage[]; strategy?: unknown; candidateRevision?: number; glbSha256?: string };
