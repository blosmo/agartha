...
export type StudioAction = {
  action: 'inspect_scene' | 'inspect_resources' | 'inspect_object' | 'edit' | 'render_views' | 'accept' | 'restore' | 'finish' | 'search_templates' | 'inspect_template' | 'build_template' | 'search_assets' | 'load_asset' | 'prepare_asset' | 'publish_asset' | 'search_materials' | 'load_material' | 'prepare_material' | 'publish_material';
  code: string; objectName: string; views: Array<'hero' | 'front' | 'right' | 'back' | 'detail'>; summary: string; critique: string;
};
const actions = ['inspect_scene', 'inspect_resources', 'inspect_object', 'edit', 'render_views', 'accept', 'restore', 'finish', 'search_templates', 'inspect_template', 'build_template', 'search_assets', 'load_asset', 'prepare_asset', 'publish_asset', 'search_materials', 'load_material', 'prepare_material', 'publish_material'] as const;
