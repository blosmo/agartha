...
Reference-guided jobs may set `shareMaterials: true` to contribute newly authored generic materials after visual review. This permission is fixed at job creation; omitted means private authoring. See [procedural material authoring](./material-authoring.md) for editable sources, PBR baking, shared discovery and reuse.
