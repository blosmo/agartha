...
from .config import BLENDER_SERIES, BLENDER_VERSION, UPSTREAM_COMMIT

BLENDER_ARCHIVE = f"blender-{BLENDER_VERSION}-linux-x64.tar.xz"
BLENDER_URL = f"https://download.blender.org/release/Blender{BLENDER_SERIES}/{BLENDER_ARCHIVE}"
BLENDER_CHECKSUMS_URL = f"https://download.blender.org/release/Blender{BLENDER_SERIES}/blender-{BLENDER_VERSION}.sha256"
