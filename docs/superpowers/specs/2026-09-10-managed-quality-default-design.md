...
- New jobs use workflow version 3 after the deployment setting `AGARTHA_MANAGED_WORKFLOW_VERSION=3` is activated. Persist the version on creation; existing jobs and retries retain their original version and reference choice.
